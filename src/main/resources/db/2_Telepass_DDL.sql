...
CREATE SEQUENCE seq_casello
  ...
  CREATE TABLE TELEPASS.TB_CASELLO(
    ID_CASELLO_PK NUMBER(8,0) DEFAULT seq_casello.NEXTVAL PRIMARY KEY NOT NULL,
	KM NUMBER(5,0),
	INGRESSI NUMBER(3,0),
...
--------------------------------------------------------
  CREATE TABLE TELEPASS.TB_TRANSPONDER(
    CODICE_TRANSP_PK NUMBER(10) DEFAULT seq_transponder.NEXTVAL PRIMARY KEY NOT NULL ,
...
--------------------------------------------------------
  ...
  CREATE TABLE TELEPASS.TB_VIAGGIO (
    ID_VIAGGIO_PK NUMBER(8,0) DEFAULT seq_viaggio.NEXTVAL PRIMARY KEY NOT NULL,
